        ...
        <div className="block sm:hidden">
          <div className="flex items-center justify-between mb-3">
            <motion.button
              ...
              className="btn-primary flex items-center space-x-2 space-x-reverse disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 text-sm px-3 py-2"
            >
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex items-center space-x-2 space-x-reverse bg-gray-100 dark:bg-gray-800 px-2 py-2 rounded-lg">
