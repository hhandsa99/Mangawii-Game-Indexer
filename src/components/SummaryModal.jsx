    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          style={{
            background: isDark ? 'rgba(15, 16, 20, 0.85)' : 'rgba(255,255,255,0.92)',
            border: isDark ? '1px solid rgba(251, 191, 36, 0.15)' : '1px solid rgba(0,0,0,0.06)',
            boxShadow: isDark ? '0 25px 50px -12px rgba(0, 0, 0, 0.6)' : '0 10px 24px rgba(0,0,0,0.12)',
                          ...
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <div className="order-3 shrink-0 flex items-center gap-2 text-xs sm:text-sm whitespace-nowrap">
                              ...
                              {status === 'online' ? (
                                ...
                                <span className="font-bold" style={{ color: '#fbbf24' }}>كراك</span>
                              )}
                            </div>
                          </div>
                        </div>
            ...
            {!hasChanges ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                <motion.button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 h-12 px-3 rounded-lg font-semibold shadow-lg transition bg-nitro-gradient text-white hover:opacity-90"
