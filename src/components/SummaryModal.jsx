        ...
        >
          ...
          <div className="p-4 sm:p-6 border-t border-gray-200 dark:border-gray-700">
            {hasChanges && removedNames.length > 0 && (
              <div className="mb-3">
                <div className="text-sm font-bold text-red-600 dark:text-red-400 mb-1">سيتم إزالة الألعاب التالية:</div>
                <ul className="list-disc pr-5 text-sm text-gray-800 dark:text-gray-200 space-y-1">
            ...
            {!hasChanges ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={applyOnly}
                  className="w-full inline-flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg min-h-[44px] bg-primary-600 hover:bg-primary-700 text-white font-semibold shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-600/80 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-gray-800 transition"
