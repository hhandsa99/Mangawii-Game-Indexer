...
const GameList = ({ games, selectedGames, onGameSelection, onSelectAll, totalGames, layoutMode = 'grid', gridDensity = 'cozy', preloadVersion = 0 }) => {
  ...
  // Preload priority images when URLs are known
  React.useEffect(() => {
    const links = [];
    for (const name of priorityNames) {
      const src = imageMap[name] || fallbackUrl;
      if (!src) continue;
      try {
        ...
        // Provide sizes hint similar to <img sizes>
        link.setAttribute('imagesizes', '(min-width:1280px) 16.66vw, (min-width:1024px) 20vw, (min-width:768px) 25vw, (min-width:640px) 33.33vw, 50vw');
  ...
  }, [priorityNames, imageMap, fallbackUrl]);
                ...
                <div className="relative w-full aspect-[3/4] bg-gray-200 dark:bg-neutral-800 overflow-hidden">
                  ...
                  {imageMap[game.Name] === undefined ? (
                    ...
                    (() => {
                      ...
                      const chosen = preferred || fallbackUrl;
                      ...
                      return (
                        <>
                          ...
                          <img
                            ...
                            onError={(e) => {
                              if (fallbackUrl && e.currentTarget.src !== encodeURI(fallbackUrl)) {
                                e.currentTarget.src = encodeURI(fallbackUrl);
                              }
                            }}
                          />
                        </>
