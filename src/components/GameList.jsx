                          ...
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <div className="order-3 shrink-0 flex items-center gap-2 text-xs sm:text-sm whitespace-nowrap">
                              ...
                              {(g.__section || 'offline') === 'online' ? (
                                ...
                                <span className="font-bold" style={{ color: 'rgba(251, 191, 36, 0.7)' }}>كراك</span>
                              )}
                            </div>
                          </div>
                        </div>
    ...
    >
      ...
      <div className="flex items-center space-x-3 space-x-reverse mb-3 max-w-[1423px] mx-auto px-8">
        ...
        <div className="flex items-center space-x-2 space-x-reverse text-sm text-gray-700 dark:text-gray-300">
          <Gamepad2 className="h-4 w-4" style={{ color: 'rgba(251, 191, 36, 0.7)' }} />
              ...
              {items.map((game, index) => {
                ...
                return (
                  <motion.button
                    ...
                    className={`text-left rounded-none overflow-hidden bg-transparent dark:bg-transparent relative group focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 w-full xl:w-[220.5px] flex flex-col ${selected ? 'shadow-lg' : ''}`}
                    aria-pressed={selected}
                  >
                    {/* Image (2:3) with ambient glow on hover */}
                    <div className="relative z-0 w-full aspect-[2/3] transition-shadow duration-300 group-hover:shadow-[0_14px_48px_rgba(0,0,0,0.22)] dark:group-hover:shadow-[0_14px_48px_rgba(255,255,255,0.07)]">
                      {/* Clipped inner to keep rounded corners; outer wrapper holds shadow */}
                      <div className="absolute inset-0 bg-gray-200 dark:bg-neutral-800 overflow-hidden" style={{ clipPath: 'inset(0 round 0)', border: '1px solid rgba(255, 0, 0, 0)' }}>
                    ...
                    <div className="px-3 py-2">
                      ...
                      <div dir="rtl" className="mt-1 text-[14px] text-center">
                        ...
                        {(game.__section || 'offline') === 'online' ? (
                          ...
                          <span className="font-semibold" style={{ color: '#fbbf24' }}>كراك</span>
                        )}
                      </div>
                    </div>
