          ...
          >
            ...
            <div className="flex items-center gap-2 justify-center sm:justify-start">
              <button
                ...
                className={`px-3 py-2 rounded-md text-sm font-bold border transition-colors ${layoutMode === 'grid' ? 'bg-primary-600 text-white border-primary-600' : 'bg-white text-gray-800 border-gray-300 dark:bg-neutral-900 dark:text-gray-100 dark:border-neutral-700'}`}
              ...
              <button
                ...
                className={`px-3 py-2 rounded-md text-sm font-bold border transition-colors ${layoutMode === 'list' ? 'bg-primary-600 text-white border-primary-600' : 'bg-white text-gray-800 border-gray-300 dark:bg-neutral-900 dark:text-gray-100 dark:border-neutral-700'}`}
