...
function App() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'dark' : ''}`} style={{ backgroundColor: isDarkMode ? 'transparent' : '#f5f7fb' }}>

      <AmbientBackground isDark={isDarkMode} />

      {/* Dark mode class for Tailwind */}
      <div className={`relative z-10 ${isDarkMode ? 'dark' : ''}`}>
        <WelcomeTour
